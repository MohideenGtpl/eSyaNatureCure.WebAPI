...
namespace eSyaNatureCure.WebAPI.Controllers
{
    ...
    public class MembershipRegistrationController : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> GetMembershipHeaderByMemberId(DO_MembershipHeader objm)
        {
            var _mship = await _membershipRegistrationRepository.GetMembershipHeaderByMemberId(objm);
            return Ok(_mship);
        }
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetMembershipTypes(int businesskey, long memberId)
        {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetMembershipDonations(int businesskey, long memberId)
        {
            var _mship = await _membershipRegistrationRepository.GetMembershipDonations(businesskey, memberId);
            return Ok(_mship);
        }
