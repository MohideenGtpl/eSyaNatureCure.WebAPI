...
namespace eSyaNatureCure.WebAPI.Controllers
{
    ...
    public class PackagePriceController : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> InsertPackagePrice(DO_PackagePrice obj)
        {
        ...
        /// </summary>
        [HttpPost]
        public async Task<IActionResult> ActiveOrDeActivePackagePrice(DO_PackagePrice objprice)
        {
            var msg = await _PackagePriceRepository.ActiveOrDeActivePackagePrice(objprice);
            return Ok(msg);

        }

        /// <summary>
        /// Getting   Occupancy Type for dropdown.
        /// UI Reffered - GuestBooking
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetActiveOccupancyTpe()
        {
            var occupancytypes = await _PackagePriceRepository.GetActiveOccupancyTpe();
            return Ok(occupancytypes);
        }
