...
namespace eSyaNatureCure.WebAPI.Controllers
{
    ...
    public class GuestCheckOutController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GuestBookingCancellationProcess(DO_GuestCheckInDetails obj)
        {
            var gd = await _guestCheckOutRepository.GuestBookingCancellationProcess(obj);
            return Ok(gd);
        }
    }
}