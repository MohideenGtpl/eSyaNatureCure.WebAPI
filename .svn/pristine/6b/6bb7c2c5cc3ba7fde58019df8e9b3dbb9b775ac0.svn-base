...
namespace eSyaNatureCure.WebAPI.Controllers
{
    ...
    public class RoomReservationController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetRoomReservationsbyBusinesskey(int businesskey, int roomtypeId,string roomNumber)
        {
            var _rs = await _roomReservationRepository.GetRoomReservationsbyBusinesskey(businesskey, roomtypeId, roomNumber);
            return Ok(_rs);
        }
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetActiveRoomNumbers()
        {
            var _rnos = await _roomReservationRepository.GetActiveRoomNumbers();
            return Ok(_rnos);
        }
